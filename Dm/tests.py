...
from Dm.models import CanalMensaje, CanalUsuario, Canal
...
class CanalTestCase(TestCase):
    def setUp(self):
        self.usuario_a= User.objects.create(username='usuarioa', password='usuario1')
        self.usuario_b= User.objects.create(username='usuariob', password='usuario2')
        self.usuario_c= User.objects.create(username='usuarioc', password='usuario3')
